#
#  Be sure to run `pod spec lint Presentr.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Daniel Lozano"
  # s.authors            = { "Daniel Lozano" => "danlozano@gmail.com" }
  ...
  s.resources = "Presentr/**/*.{png,jpeg,jpg,storyboard,xib}"
